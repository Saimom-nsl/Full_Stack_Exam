...
const UpdateProject = () => {
    ...
    const {projectId,projectInfo,setAlertData} = useContext(ProjectContext)
    const [reportData, setReportData] = useState({
        title: projectInfo.title, startDate: projectInfo.startDate.split('T')[0], endDate: projectInfo.endDate.split('T')[0], description: projectInfo.description, teamLead: projectInfo.teamLead._id, members:projectInfo.members._id
    })
    ...
    const updateProject =async (e) => {
        ...
        const res = await fetch(`${process.env.REACT_APP_URL}/updateProject/${projectId}`, {
            method: "PUT",
            headers: {
        ...
        if (res.status === 400) {
            ...
            //     title: "", startDate: "", endDate: "", description: "", teamLead: "",members:""
            // }) 
            setAlertData({message:"Project deleted Successfully", code:"success"})
                        ...
                        <div className="form-group mt-5">
                            ...
                            <div className="input-group mt-3 px-3">
                                ...
                                <div className="form-group for-btn py-3">
                                    <input type="submit" name="signup" className="btn btn-primary btn-lg mt-3" value="Update" onClick={updateProject} />
                                </div>
                            </div>
                    </form>
